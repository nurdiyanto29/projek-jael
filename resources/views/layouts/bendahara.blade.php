    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3">Bendahara <sup></sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        {{-- <a class="collapse-item" href="{{ route('idarah.index')}}">Idarah</a> --}}
                        <a class="collapse-item" href="{{ route('keuangan.index')}}">Keuangan</a>
                        <a class="collapse-item" href="{{ route('barang.index')}}">Sumbangan Barang</a>
                        {{-- <a class="collapse-item" href="{{ route('imarah.index')}}">Imarah</a>
                        <a class="collapse-item" href="{{ route('riayah.index')}}">Riayah</a> --}}
                    </div>
                </div>
            </li>
            <li class="nav-item">
